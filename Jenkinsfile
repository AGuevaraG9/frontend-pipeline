pipeline {
    ...
    parameters {
        ...
        string(name: 'BUCKET_TARGET', defaultValue: 'bucket-codigo-abel', description: 'Nombre del bucket objetivo..')
        string(name: 'CARPETA_USUARIO', defaultValue: 'AbelGuevara', description: 'Nombre de la carpeta del usuario..')
